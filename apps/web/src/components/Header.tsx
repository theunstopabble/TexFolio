      ...
      <div className="max-w-7xl mx-auto px-6 h-20">
        <div className="flex items-center justify-between h-full">
          ...
          <Link to="/" className="flex items-center gap-2 group no-underline">
            ...
            <span className="text-2xl font-extrabold bg-gradient-to-r from-slate-900 to-slate-700 bg-clip-text text-transparent group-hover:from-blue-700 group-hover:to-purple-700 transition-all duration-300">
              TexFolio
            </span>
          </Link>
          ...
          <div className="flex items-center gap-4">
            {user ? (
              <div className="flex items-center gap-3 pl-2">
                <Link
                  to="/create"
                  className="bg-slate-900 text-white text-base font-extrabold px-5 py-2.5 rounded-full hover:bg-slate-800 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200 mr-4 no-underline"
                >
                  + New
                </Link>
